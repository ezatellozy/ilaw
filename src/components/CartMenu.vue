                  ...
                  <div class="media">
                    ...
                    <div class="media-body ml-4d875">
                      ...
                      <div class="font-size-2 mb-1 text-truncate">
                        <a href="#" class="text-gray-700">Robert Iger</a>
                      </div>
                      <div
                ...
                <div class="px-4 py-5 px-md-6 border-bottom">
                  <div class="media">
                    ...
                    <div class="media-body ml-4d875">
                      ...
                      >
                        <a href="#" class="text-dark">
                          The Rural Diaries: Love, Livestock, and Big Life
                          Lessons Down
                        </a>
                      </h2>
                      <div class="font-size-2 mb-1 text-truncate">
                        <a href="#" class="text-gray-700">Hillary Burton</a>
                      </div>
                      <div
                        class="price d-flex align-items-center font-weight-medium font-size-3"
                      >
                ...
                <div class="px-4 py-5 px-md-6 border-bottom">
                  <div class="media">
                    ...
                    <div class="media-body ml-4d875">
                      ...
                      >
                        <a href="#" class="text-dark">
                          Russians Among Us: Sleeper Cells, Ghost Stories, and
                          the Hunt.
                        </a>
                      </h2>
                      <div class="font-size-2 mb-1 text-truncate">
                        <a href="#" class="text-gray-700">Gordon Corera</a>
                      </div>
                      <div
                        class="price d-flex align-items-center font-weight-medium font-size-3"
                      >
