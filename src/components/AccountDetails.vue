...
export default {
  setup() {
    ...
    const phone = ref(user[0].phone)
    const address = ref(user[0].address)
    const defaultLanguage = ref(user[0].default_language)

    return { name, username, phone, email, address, defaultLanguage }
  },
}
</script>
